...
<dl class="leftmenu">
  <dd>
    ...
    <ul class="menuson">
      ...
      <li>
        <div class="header"> <cite></cite> <a href="<%=basePath %>/pages/admin/bill/checkin.jsp" target="rightFrame">入住信息添加</a> <i></i> </div>
      </li>
      <li class="active">
      ...
      <li>
        <div class="header">
        <cite></cite><a href="<%=basePath %>/pages/admin/bill/out.jsp" target="rightFrame">结账退房</a><i></i></li>
      </div>
    </ul>
  </dd>
  <dd>
